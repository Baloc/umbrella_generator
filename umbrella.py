...
def triangle(list_load):
    data = {'vlans': {sw1_name: {'vid': 101, 'description': qs(vlan_name), 'acl_in': 1}, sw2_name: {'vid': 102, 'description': qs(vlan_name), 'acl_in': 2}, sw3_name: {'vid': 103, 'description': qs(vlan_name), 'acl_in': 3}} , 
    ...
    for i in range(len(list_load)):
        if list_load[i]['switch'] == sw1_name and list_load[i]['status'] == 'Production':
            data['dps'][sw1_name]['interfaces'][int(list_load[i]['port'])] = {'name': qs(list_load[i]['hostname']), 'description': qs(
                list_load[i]['hostname']), 'native_vlan': sw1_name}
            data['acls'][1].append({'rule': {'dl_dst': qs(list_load[i]['macaddr']), 'actions': {
        ...
        elif list_load[i]['switch'] == sw2_name and list_load[i]['status'] == 'Production':
            data['dps'][sw2_name]['interfaces'][int(list_load[i]['port'])] = {'name': qs(list_load[i]['hostname']), 'description': qs(
                list_load[i]['hostname']), 'native_vlan': sw2_name}
            data['acls'][1].append({'rule': {'dl_dst': qs(list_load[i]['macaddr']), 'actions': {
        ...
        elif list_load[i]['switch'] == sw3_name and list_load[i]['status'] == 'Production':
            data['dps'][sw3_name]['interfaces'][int(list_load[i]['port'])] = {'name': qs(list_load[i]['hostname']), 'description': qs(
                list_load[i]['hostname']), 'native_vlan': sw3_name}
            data['acls'][1].append({'rule': {'dl_dst': qs(list_load[i]['macaddr']), 'actions': {
